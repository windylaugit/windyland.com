...
INSERT INTO `wl_column` (`c_id`, `c_name`, `alias`, `parent_id`, `ctype_id`, `sort_order`, `if_show`) VALUES ('2', '编程技术', '', '0', '1', '255', '1');
INSERT INTO `wl_column` (`c_id`, `c_name`, `alias`, `parent_id`, `ctype_id`, `sort_order`, `if_show`) VALUES ('5', '编程栏目A', '', '2', '1', '255', '1');
INSERT INTO `wl_column` (`c_id`, `c_name`, `alias`, `parent_id`, `ctype_id`, `sort_order`, `if_show`) VALUES ('6', '编程栏目B', '', '2', '1', '255', '1');
INSERT INTO `wl_column` (`c_id`, `c_name`, `alias`, `parent_id`, `ctype_id`, `sort_order`, `if_show`) VALUES ('7', '编程栏目C', '', '2', '1', '255', '1');
INSERT INTO `wl_column` (`c_id`, `c_name`, `alias`, `parent_id`, `ctype_id`, `sort_order`, `if_show`) VALUES ('8', '应用平台', '', '0', '2', '255', '1');
