...
CREATE TABLE `wl_column` (
  ...
  `custom_url` varchar(200) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `ctype_id` int(10) unsigned NOT NULL DEFAULT '1',
  `ctype_index` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `wl_column` (`c_id`, `c_name`, `custom_url`, `parent_id`, `ctype_id`, `ctype_index`, `sort_order`, `code`, `if_show`) VALUES ('2', '编程技术', '', '0', '1', '0', '255', NULL, '1');
INSERT INTO `wl_column` (`c_id`, `c_name`, `custom_url`, `parent_id`, `ctype_id`, `ctype_index`, `sort_order`, `code`, `if_show`) VALUES ('5', '编程栏目A', '', '2', '1', '0', '255', NULL, '1');
INSERT INTO `wl_column` (`c_id`, `c_name`, `custom_url`, `parent_id`, `ctype_id`, `ctype_index`, `sort_order`, `code`, `if_show`) VALUES ('6', '编程栏目B', '', '2', '1', '0', '255', NULL, '1');
INSERT INTO `wl_column` (`c_id`, `c_name`, `custom_url`, `parent_id`, `ctype_id`, `ctype_index`, `sort_order`, `code`, `if_show`) VALUES ('7', '编程栏目C', '', '2', '1', '0', '255', NULL, '1');
INSERT INTO `wl_column` (`c_id`, `c_name`, `custom_url`, `parent_id`, `ctype_id`, `ctype_index`, `sort_order`, `code`, `if_show`) VALUES ('8', '应用平台', '', '0', '2', '0', '255', NULL, '1');
